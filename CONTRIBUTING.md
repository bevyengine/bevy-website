...
11. To make sure your web-based files (html, markdown, css) are formatted correctly run the command `markdownlint -f -c .github/linters/.markdown-lint.yml . && djlint` in the root directory of your local Bevy website repository. In order to run the command you should install `markdownlint-cli`, `djlint`, and `editorconfig-checker`. See: <https://github.com/igorshubovych/markdownlint-cli> and <https://www.djlint.com/docs/getting-started/>
