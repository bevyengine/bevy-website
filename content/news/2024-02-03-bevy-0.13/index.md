...
We upgrade from wgpu 0.17 in Bevy 0.12 to wgpu 0.19, which includes the long awaited wgpu [arcanization](https://gfx-rs.github.io/2023/11/24/arcanization.html) that allows us to do things like compile shaders in parallel in the background to avoid shader compilation stutters, and to multithread draw call creation for better performance.
