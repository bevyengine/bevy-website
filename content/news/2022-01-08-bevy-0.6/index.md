...
For those working directly with `World`, this is a game changer. It makes it possible to mutably access multiple disjointed Components and Resources (often eliminating the need for more costly abstractions like `WorldCell`).
