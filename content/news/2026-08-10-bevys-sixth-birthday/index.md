...
We did not land a baseline editor platform upstream. As mentioned above, we have made solid progress on the foundations. The ECS Inspector working group has a functional inspector implementation. And Jackdaw has successfully prototyped what an editor platform could look like. We made significant, tangible and usable progress toward the goal this year. We are _so close_ :)
