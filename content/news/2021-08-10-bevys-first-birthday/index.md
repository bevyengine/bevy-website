...
This year we invested heavily in what I call The Bevy App Model. Bevy {{rust_docs(type="struct", crate="bevy_app", name="App", plural=true)}} are easy to understand, ergonomic to write, and modular via {{rust_docs(type="trait", crate="bevy_app", name="Plugin", plural=true)}}. My goal was to blur the lines between engine developers and app developers. I think we absolutely nailed it:
