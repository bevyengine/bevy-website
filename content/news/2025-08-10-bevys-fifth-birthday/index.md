...
* **September 25**: [Bevy Foundation is granted 501(c)(3) Public Charity status](https://bevy.org/news/bevy-foundation-501c3/)
  * This gave us tax-exempt status, made donations tax-deductable, and introduced stricter constraints on how we operate (with the goal of making the Bevy Foundation as trustable as possible).
