...
* **[François Mockers (@mockersf)](https://github.com/sponsors/mockersf)** for improving our CI by [orders](https://bevyengine.org/news/bevy-0-11/#new-ci-jobs) of [magnitude](https://bevyengine.org/news/bevy-0-10/#ci-improvements) this year, and for doing the polyglot job of making sure things "actually work" across most areas of the engine (especially the web platform).
...
[Bevy Asset V2](https://github.com/bevyengine/bevy/pull/8624) didn't _quite_ land in [Bevy 0.11](https://bevyengine.org/news/bevy-0-11/), but it _has_ entered the final review phase and should land in the **Bevy 0.12** (mid October).
...
Scenes [did get a prettier format](https://bevyengine.org/news/bevy-0-9/#new-scene-format), but we did not add support for scene nesting or property overloading. I'll call this a partial win!
