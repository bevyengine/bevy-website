...
### [Update `KeyCode` to new variants](https://github.com/bevyengine/bevy/pull/10702)

<div class="migration-guide-area-tags">
    <div class="migration-guide-area-tag">Input</div>
</div>

Several `KeyCode` variants have been renamed and now represent physical keys on the keyboard, replacing `ScanCode`. In many cases, variants now have a `Key` prefix.
