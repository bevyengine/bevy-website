...
There's a good chance you'll want your game to have visual elements, like adding image sprites to characters, using 3D meshes to represent objects, or even creating custom shaders for unique visual effects.
...
When we talk about the "Bevy Renderer", we're actually referring to a collection of crates and feature flags that can be toggled on and off in order to add specific functionality to your Bevy application.
...
All of these are grouped under a "render" category, and we'll document them throughout this chapter.
