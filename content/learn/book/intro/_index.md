...
Bevy is a modern, ECS (Entity Component System)-first game engine written in Rust. It is [free and open source](https://github.com/bevyengine/bevy) forever! We aim to be:
...
The [Bevy Foundation](https://bevy.org/foundation/) is a 501(c)(3) nonprofit that exists to develop Bevy and help people learn how to use it.
