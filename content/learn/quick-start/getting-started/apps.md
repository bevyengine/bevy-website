...
The `use bevy::prelude::*` statement brings in the essential things from Bevy.
For brevity, this guide may omit it in later steps.

Nice and simple right?
Copy the code above into your `main.rs` file, then run `cargo run` in the command line while in your project folder.

You will notice that nothing happens.
This is because we haven't told our app to do anything yet!
Apps are just empty shells capable of running our application logic.
If you'd like to learn more, then continue reading.
Otherwise you can head to the next page to learn how to add logic to our App!

## What makes an App?

What sort of data does our [`App`] _actually_ store?
Looking at the linked docs, you'll find three fields: `world`, `schedule`, and `runner`.
...
We will cover these a bit more in the next pages.
